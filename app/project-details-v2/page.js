                    ...
                    <section className="flat-location flat-slider-detail-v1">
                        <div className="swiper tf-sw-location">
                            <Swiper {...swiperOptions} className="swiper-wrapper">
                                {projectDetails?.picture.length > 0 && projectDetails.picture.map((item, index) => (
                                    <SwiperSlide >
                            ...
                            <div className="header-property-detail">
                                <div className="content-top d-flex justify-content-between align-items-center">
                                    <div className="box-name">
                                        <Link href="#" className="flag-tag primary">for sale</Link>
                                        <h4 className="title link">{projectDetails?.title}</h4>
                                    </div>
                                ...
                                <div className="col-lg-8">
                                    ...
                                    <div className="single-property-element single-property-overview">
                                        ...
                                        <ul className="info-box">
                                            ...
                                            {projectDetails.meta_details.length > 0 && projectDetails.meta_details.map((item, index) => (
                                                <>{(item.value) !== "0" ? (
                                        ...
                                        <div className="single-property-element single-property-feature">
                                            ...
                                            <div className="wrap-feature">
                                                <div className="box-feature">
                                                    <ul>
                                                        {projectDetails.meta_details.map((projectDetail) => (
                                            ...
                                            <div className="box-avatar">
                                                {projectDetails?.user_image ? (
                                                    <div className="avatar avt-100 round">
                                                        <img src={projectDetails?.user_image} alt="avatar" />
                                                    </div>
                                                ) :
                                                    null
                                                }
											...
											<div className="archive-top">
												<Link href="#" className="images-group">
													<div className="images-style">
														<img src={property.picture[0]} alt={property.title} />
													</div>
													<div className="top">
