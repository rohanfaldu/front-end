	...
	return (
		<>
			...
			<Layout headerStyle={1} footerStyle={1}>
				<div>
					<section className="flat-section-v6 flat-property-detail-v4">
						<div className="container">
							...
							<div className="single-property-gallery">
								<div className="position-relative">
									...
									<div className="box-navigation">
										<div className="navigation swiper-nav-next nav-next-single"><span className="icon icon-arr-l" /></div>
										<div className="navigation swiper-nav-prev nav-prev-single"><span className="icon icon-arr-r" /></div>
									</div>
								</div>
							...
							<div className="single-property-element single-property-nearby">
								...
								<div className="grid-3 box-nearby">
							...
							<div className="single-property-element single-property-contact">
								<div className="h7 title fw-7">Contact Sellers</div>
								<div className="widget-box bg-surface">
									<div className="box-avatar">
										...
										<div className="info">
											...
											<span>1-333-345-6868 <br /> themesflat@gmail.com</span>
										</div>
									</div>
