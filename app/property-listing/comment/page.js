  ...
  const closeModal = () => {
   ...
   const exportToExcel = async () => {
        try {
          ...
          worksheet.columns = [
            ...
            { header: "Property View", key: "property_comment", width: 40 },
          ];
          ...
          properties.forEach((p) => {
            worksheet.addRow({
              ...
              property_comment: p?.comment_count || "N/A",
            });
          });
   ...
   const exportToPDF = () => {
      ...
      const tableBody = properties.map((property) => [
        property?.title || "N/A",
        property?.price || "N/A",
        property?.comment_count || "N/A",
      ]);
  
      // Generate table
      autoTable(doc, {
        head: [["Property Title", "Property Price", "Property Comment",]],
        body: tableBody,
        columnStyles: {
          0: { cellWidth: 50 },
          1: { cellWidth: 40 },
