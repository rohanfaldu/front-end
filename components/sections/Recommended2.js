...
export default function Recommended2() {
	return (
		<>
			...
			<section className="flat-section flat-recommended pt-0 wow fadeInUpSmall" data-wow-delay=".4s" data-wow-duration="2000ms">
				<div className="container">
					<div className="box-title style-2 text-center">
						...
						<h4 className="mt-4">Discover Homeya's Finest Properties for Your Dream Home</h4>
					</div>
					<div className="row">
						...
						<div className="col-xl-3 col-md-6">
							<div className="homeya-box md">
								<div className="archive-top">
									...
									<div className="content">
										<div className="text-1 text-capitalize"><Link href="/property-details-v3" className="link">Rancho Vista Verde</Link></div>
										<div className="desc"><i className="fs-16 icon icon-mapPin" />
						...
						<div className="col-xl-3 col-md-6">
							<div className="homeya-box md">
								<div className="archive-top">
									...
									<div className="content">
										<div className="text-1 text-capitalize"><Link href="/property-details-v4" className="link">Sunset Heights Estate</Link></div>
										<div className="desc"><i className="fs-16 icon icon-mapPin" />
						...
						<div className="col-xl-3 col-md-6">
							<div className="homeya-box md">
								<div className="archive-top">
									...
									<div className="content">
										<div className="text-1 text-capitalize"><Link href="#" className="link">Mountain Mist
											Retreat, Aspen</Link></div>
										<div className="desc"><i className="fs-16 icon icon-mapPin" />
											<p>7 Cedar Street, Austin, TX</p>
										</div>
										<ul className="meta-list">
											<li className="item">
												<i className="icon icon-bed" />
						...
						<div className="col-xl-3 col-md-6">
							<div className="homeya-box md">
								<div className="archive-top">
									...
									<div className="content">
										<div className="text-1 text-capitalize"><Link href="#" className="link">Seaside Bliss
											Residence</Link></div>
										<div className="desc"><i className="fs-16 icon icon-mapPin" />
											<p>15 Willow Street, Seattle, WA</p>
										</div>
